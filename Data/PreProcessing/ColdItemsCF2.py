...
for kos in kind_of_set:
    ...
    # Load set 
    with open('/Users/nicholas/ReDial/Data/CF2/' + kos +'.json') as fp:
        dataset = json.load(fp)
        
    # Split data according to presence in train
    for datapoint in dataset:
        target = datapoint[4]   # target is idx 4 and has one tuple in the list
    ...
    # Save sets splited
    with open('/Users/nicholas/ReDial/Data/CF2/' + kos +'_seen.json', 'w') as fp:
        json.dump(set_seen, fp)
    with open('/Users/nicholas/ReDial/Data/CF2/' + kos +'_new.json', 'w') as fp:
...
with open('/Users/nicholas/ReDial/Data/CF2/Test_new.json', 'r') as fp:
    edtn = json.load(fp)        
with open('/Users/nicholas/ReDial/Data/CF2/Test_seen.json', 'r') as fp:
    edts = json.load(fp)   
with open('/Users/nicholas/ReDial/Data/CF2/Val_new.json', 'r') as fp:
    edvn = json.load(fp)   
with open('/Users/nicholas/ReDial/Data/CF2/Val_seen.json', 'r') as fp:
    edvs = json.load(fp)         
